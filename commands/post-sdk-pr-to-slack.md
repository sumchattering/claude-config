...
4. **Post to Slack**: Use the Slack MCP `slack_send_message` tool with channel_id `C0956CRHEE6`:

   **For Swift PRs:**
   ```
   <PR_URL> <brief description> :apple: :twisted_rightwards_arrows: :pr-fresh: @joao.dordio @Jena @Akshay
   ```

   **For Android PRs:**
   ```
   <PR_URL> <brief description> :android: :twisted_rightwards_arrows: :pr-fresh: @joao.dordio @Jena @Akshay
   ```
...
**Swift PR:**
```
https://github.com/Iterable/iterable-swift-sdk/pull/994 PR for fixing the carthage build issues :apple: :twisted_rightwards_arrows: :pr-fresh: @joao.dordio @Jena @Akshay
```

**Android PR:**
```
https://github.com/Iterable/iterable-android-sdk/pull/500 Add new inbox feature :android: :twisted_rightwards_arrows: :pr-fresh: @joao.dordio @Jena @Akshay
```

5. **Confirm**: Report success or any errors to the user.
