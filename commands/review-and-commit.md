...
This command reviews your code changes using a Sonnet subagent, addresses any issues found, then creates a meaningful commit.

**Note**: This command does NOT push your changes. Use `git push` manually or `/commit-push-pr` if you want to push.
...
- Report success to the user with the commit hash
